    ...
    <section className="resume_section" id="Experience">
      ...
      <section className="experience_content">
        <section className="experience_item">
          ...
          <a
            href="https://securite-ferroviaire.fr/"
            target={"_blank"}
            rel={"noreferrer"}
          >
          ...
          <ul className="experience_description">
            <li>
              Application du Traitement Automatique des Langues (TAL/NLP) aux
              notifications des événements de sécurité ferroviaire
            </li>
        ...
        <section className="experience_item">
          <div className="experience_header">
            <div className="experience_title">
              Assistant Ingénieur Informatique
            </div>
            <div className="experience_date">Aou 2021 - Fev 2022</div>
          </div>
          <a href="https://www.sysnav.fr" target={"_blank"} rel={"noreferrer"}>
            <div className="experience_company">Sysnav</div>
          </a>
          <ul className="experience_description">
            <li>
              Recherche et Développement d’un serveur de tuiles personnalisables
            </li>
            <li>
              Preuve de concept utilisée pour les technologies de
              géolocalisation des piétons. Géolocalisation faite à partir de la
              technologie brevetée Sysnav fonctionnant avec une centrale
              magnéto-inertielle.
            </li>
          </ul>
        </section>
        ...
        <section className="experience_item">
          ...
          <a href="https://www.utc.fr" target={"_blank"} rel={"noreferrer"}>
            <div className="experience_company">
          ...
          <ul className="experience_description">
            <li>
              Présentation de l'UTC pendant les lives, salons étudiants, portes
              ouvertes
            </li>
        ...
        <section className="experience_item">
          ...
          <ul className="experience_description">
            <li>
              Maintenance audiovisuel de la partie Musée de Nausicaà (12V et
              220V)
            </li>
